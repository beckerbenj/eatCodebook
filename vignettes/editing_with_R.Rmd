...
Pull the repo and start with the file `SH_main.R`. At the start you see all the packages that you need to install or load before starting. 
...
#### Editing Descriptive Statistics in R
