...
inputForDescriptives <- createInputForDescriptives(GADSdat = eatGADS::pisa)
...
showFunctions <- calculateDescriptives(GADSdat = eatGADS::pisa, inputForDescriptives = inputForDescriptives_edited, showCallOnly = TRUE)
...
descStatistics <- calculateDescriptives(GADSdat = eatGADS::pisa, inputForDescriptives = inputForDescriptives_edited, showCallOnly = FALSE)
descStatistics[[50]]
```
