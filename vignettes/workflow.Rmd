...
This vignettes describes the typical workflow of creating a codebook via the `eatCodebook` package. For illustrative purposes we use a small example package which comes alongside the package and contains different types of variables (e.g., numeric, categorical, pooled variables, scales). We import the data set using the `eatGADS` package, which is automatically installed when `eatCodebook` is installed.
...
eatAnalysis::write_xlsx(miss, "example_miss.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(miss, "example_varInfo.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(struc, "example_struc.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(scaleInfo, "example_scaleInfo.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(register, "example_register.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(register, "example_litInfo.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(abbrList, "example_abbrList.xlsx", row.names = FALSE)
...
eatAnalysis::write_xlsx(abbrList, "example_meta.xlsx", row.names = FALSE)
