...
miss_file <- system.file("extdata", "example1b_miss.xlsx", package = "eatCodebook")
...
varInfo_file <- system.file("extdata", "example1b_varInfo.xlsx", package = "eatCodebook")
...
struc_file <- system.file("extdata", "example1b_struc.xlsx", package = "eatCodebook")
...
scaleInfo_file <- system.file("extdata", "example1b_scaleInfo.xlsx", package = "eatCodebook")
