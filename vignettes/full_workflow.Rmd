...
If a variable has been recoded in the course of previous editing, this can be marked with a *ja* in the **rekodiert** column and the variable gets a corresponding note in the codebook.  
