...
#### Numeric Variables without labelled Values
...
This is the page in the codebook, which is well suited for variables that only have labelled categories:  
<br>
...
<br>  
To get these pages the individual items must be labelled as *ordinal* and the scale as *numeric*. They must all have the same name at **group** so that they are displayed together.
<br>  
