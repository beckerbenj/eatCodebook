...
### varinfo: adding references and instructions with R

### varinfo:adding structure and subsections with R

### varinfo: adding recoded info with R

### varinfo: adding background model info with R

### varinfo: adding remarks with R
