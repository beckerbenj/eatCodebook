...
You can check once more whether everything is displayed the way you want it to. Then save it to Excel and import again with `getLitInfo()` to check for format. `makeLit()` creates the proper Latex syntax for the function `codebook()` directly from the Excel file.
