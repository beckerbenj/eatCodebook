...
<!-- Verstehe die Formulierung hier nicht ganz. Sollte ich das auf WAHR für alle imputierten Variablen stellen oder auch für alle Variablen, die gruppiert werden sollen? -->
...
<!-- In welchen Fällen müsste man denn was editieren (anstatt direkt im Datensatz zu rekodieren)? -->
...
<!-- Wird die Abkürzungsliste nicht mehr am Ende in den Anhang geschrieben und muss stattdessen der LaTeX Code manuell eingefügt werden? -->
...
<!-- Ist hier mit "name" der Titel der Variable gemeint? -->
...
#gibt es eine Empfehlung wie viele Variablen pro Unterkapitel maximal enthalten sein sollten? Im fertigen PDF gibt es ab 100 Variablen das Problem, dass im Inhaltsverzeichnis die Nummerierung zu groß wird und sich mit den Kapitelnamen überschneidet.
...
#ist es für eure Zwecke optional URLs und kursive Schrift korrekt darzustellen? Zusätzlich wäre es in der Praxis hilfreich Beispiele für beides mit korrekter LaTeX Syntax zu geben, um Nachfragen vorzubeugen

> [!NOTE]
> 
> References need to be in APA format!

#ist redundant, da es den Hinweis schon im Fließtext gibt
...
It's usually two pages: an actual cover page with the institute's logos, the title and author names and a second one with license and bibliography information.

#mir wird nicht klar welche Info genau auf dem Cover sein sollte bzw. an welcher Vorlage ich mich orientieren sollte. Am besten wäre eine Vorlage mit Angaben dazu, was darauf editiert werden sollte.
...
#vermute die Anmerkung "four lines" bezieht sich hier drauf und habe es deswegen runter gezogen
...
#Oder man nummeriert die Versionen
...
#Hier wäre eine Empfehlung für ein TeX Programm nützlich.
...
#Könnte ich nicht pdfLaTeX+MakeIndex+BibTeX verwenden um direkt das Inhaltsverzeichnis zu erhalten?
