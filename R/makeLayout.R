...
layout.var <- function(name , fb, double.vars , kennwerte.var = NULL, varue.info, varue.missings, Gesamtdatensatz, skalen.info, varue.gliederung, makeCounter , all_length ) {
  ...
  if(!i %in% 0:11) stop("Invalid value of 'i'.")
  ...
  if (i==11) layout.typ.var <- layout.gepoolt.ordinal(name=name , kennwerte.var=kennwerte.var, varue.info=varue.info, varue.missings=varue.missings, Gesamtdatensatz=Gesamtdatensatz, skalen.info=skalen.info)
