# Funktion fuer Zaehlervariablen
numtolet <- function( name , fb , double.vars) {
  ...
  #	fb: Character, Kuerzel fuer den Fragebogen aus fbshort
  # OUTPUT:
  ...
  #	Variablennamen, der in mind. 2 Datensaetzen auftaucht, muessen hier gesondert behandelt werden,
  #	da sonst mind. 2 Mal die selbe Zaehlervariable erstellt wird. Die Funktion pastet das Fragebogen-
  #	Kuerzel ans Ende des Names der Zaehlervariable, um eine eindeutige Zuordnung zu garantieren.
